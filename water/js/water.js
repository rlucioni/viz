...
var CUBIC_METERS_FACTOR, EXTENSION, FORCED_COLORS, IGNORE, TRUNCATE_DATE, area, boundingBox, canvasHeight, canvasWidth, drawLineGraph, labelPadding, line, margin, parseDate, popAxis, popScale, stack, stringToHex, svg, xAxis, xScale, yAxis, yScale,
...
drawLineGraph = function(dataset, dates, popData) {
  ...
  frame.append("text").attr("class", "y label").attr("text-anchor", "end").attr("y", labelPadding.small).attr("dy", ".75em").attr("transform", "rotate(-90)").text("Storage (m³)");
  frame.append("text").attr("class", "pop label").attr("text-anchor", "end").attr("y", boundingBox.width - labelPadding.large).attr("dy", ".75em").attr("transform", "rotate(-90)").text("Population");
