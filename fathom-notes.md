...
However, something we didn't spend a lot of time on was getting a good look at what the underlying graph representation we were working with actually looked like. 
...
In each graph, each edge _(u, v)_ is assigned weight equal to the number of times Senator _u_ and Senator _v_ voted the same way, either Yea or Nay. 
...
pride myself on being a generalist
    app development experience - Harvard Tour